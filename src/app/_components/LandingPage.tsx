...
const LandingPage: React.FC = () => {
  return (
    <div className="h-screen">
      <header className="sticky top-0 z-50 grid grid-cols-[auto,1fr] grid-rows-[auto,1fr] bg-white">
        <div className="bg-[#f0f6ff] px-[12px] py-[9px] text-center lg:col-span-7">
          <p className="inline text-[0.875rem] text-[#070c14d1]">
          ...
          <span className="inline-block">
            <a className="flex items-center" href="/platform/app-building">
              ...
              <svg
                ...
                width="18"
                height="12"
                className="ml-1 rotate-180 text-[#1b61c9]"
              >
                <path
                  d="M17 6.75a.75.75 0 0 0 0-1.5zM.47 5.47a.75.75 0 0 0 0 1.06l4.773 4.773a.75.75 0 1 0 1.06-1.06L2.061 6l4.242-4.243a.75.75 0 0 0-1.06-1.06zM17 5.25H1v1.5h16z"
                  fill="#1b61c9"
                ></path>
              </svg>
            </a>
        ...
        <nav className="col-span-2 col-start-1 row-start-2 grid grid-cols-[auto,1fr] gap-8 px-[32px]">
          ...
          <div className="hidden space-x-6 md:flex">
            <button className="hover:text-primary flex items-center font-medium transition">
              ...
              >
                <path
                  fill="currentColor"
                  fillRule="evenodd"
                  d="M8.399 4.399a.85.85 0 1 1 1.202 1.202l-3 3a.85.85 0 0 1-1.202 0l-3-3a.85.85 0 1 1 1.202-1.202L6 6.798z"
                ></path>
              </svg>
            </button>
            <button className="hover:text-primary flex items-center font-medium transition">
            ...
            <button className="hover:text-primary font-medium transition">
              Enterprise
            </button>
            <button className="hover:text-primary font-medium transition">
              Pricing
        ...
        <div className="mx-[32px] my-[22px] flex items-center justify-end">
              ...
              <div className="col-start-1 col-end-6 flex items-center justify-center">
                <div className="mx-[48px] flex max-w-[28rem] flex-col justify-center">
                  ...
                  <div className="mt-7 flex space-x-4">
                    <button className="bg-at-btn-primary shadow-at-btn-primary-shadow focus:shadow-at-btn-primary-focused hover:bg-at-btn-primary-hover hover:shadow-at-btn-primary-hover min-w-[200px] rounded-lg bg-[#1b61c9] px-2.5 px-3.5 py-[5px] py-[8px] font-medium text-white transition-colors duration-200 ease-in-out">
                      <p className="text-lg font-medium text-white">
                        Sign up for free
                      </p>
                    </button>
                    <button className="shadow-at-btn-shadow-secondary hover:bg-at-btn-secondary-hover hover:text-at-btn-primary hover:shadow-at-btn-shadow-secondary-hover min-w-[200px] rounded-lg border-2 border-[#9297a0] bg-white bg-opacity-20 px-2.5 px-3.5 py-[5px] py-[8px] font-medium transition-colors duration-150 ease-in-out">
                      <p className="text-lg font-medium">Contact Sales</p>
                    </button>
                  </div>
                </div>
              </div>
